...
public class ReusableMethods {
    ...
    public static void selectByVisibleText(WebDriver driver, String xpath, String userValue, String elementName) {
        //declare explicit wait statement
        WebDriverWait wait = new WebDriverWait(driver, 10);
        try {
            WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
    ...
    public static void selectByValue(WebDriver driver, String xpath, String userValue, String elementName) {
        //declare explicit wait statement
        WebDriverWait wait = new WebDriverWait(driver, 10);
        try {
            WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
    ...
    public static void selectByIndex(WebDriver driver, String xpath, int userValue, String elementName) {
        //declare explicit wait statement
        WebDriverWait wait = new WebDriverWait(driver, 10);
        try {
            WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
    ...
    public static void scrollIntoView(WebDriver driver, String xpath, String elementName) {
        //declare explicit wait statement
        WebDriverWait wait = new WebDriverWait(driver, 10);
    ...
    public static void scrollByPixel(WebDriver driver, String scroll) {
        //declare explicit wait statement
        WebDriverWait wait = new WebDriverWait(driver, 10);
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        try {
